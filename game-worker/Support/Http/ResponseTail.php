...
trait ResponseTail
{
    ...
    protected function header($type, $value)
    {
        return Http::header($type.':'.$value);
    }

    protected function setCookie($name, $value = '', $maxage = 0, $path = '', $domain = '', $secure = false, $HTTPOnly = false)
    {
